...
void mandelbrot(imagine_t *immagine)
{
    ...
    while (((uint32_t) immagine->image->instances->x) < immagine->image->width)
    {
        ...
        while (((uint32_t) immagine->image->instances->y) < immagine->image->height)
        {
            double zx = 0.0;
            double zy = 0.0;
            double cx = change_imaginary_image_x(immagine, immagine->image->instances->x);
            double cy = change_imaginary_image_y(immagine, immagine->image->instances->y);
            iteration = 0;
            ...
            mlx_put_pixel(immagine->image, immagine->image->instances->x, immagine->image->instances->y, color);
